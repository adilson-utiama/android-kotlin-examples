...
import com.asuprojects.kotlincustomcomponents.extensions.toPx
...
class SoftKeyBoardPopup(
...
) : PopupWindow(context), ViewTreeObserver.OnGlobalLayoutListener,  GridMenuAdapter.GridMenuListener{

    private lateinit var view: View

    private var DEFAULT_KEYBOARD_HEIGHT = 281.toPx()
    private var KEYBOARD_OFFSET = 100
    ...
    private fun initMenuView() {
        view = LayoutInflater.from(context).inflate(R.layout.menu_soft_keyboard, rootView, false)
