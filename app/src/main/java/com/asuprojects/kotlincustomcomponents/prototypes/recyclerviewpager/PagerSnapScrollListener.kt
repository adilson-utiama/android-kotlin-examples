...
open class PagerSnapScrollListener(val recyclerView: RecyclerView, val externalListener: MyPagerStateListener, maxPages: Int) : RecyclerView.OnScrollListener() {
    ...
    companion object {
        val statesArray = listOf(
            MyPageScrollState.Idle(),
            MyPageScrollState.Dragging(),
            MyPageScrollState.Settling()
        )
    }
}