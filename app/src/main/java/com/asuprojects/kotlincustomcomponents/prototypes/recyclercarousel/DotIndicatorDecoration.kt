...
import com.asuprojects.kotlincustomcomponents.extensions.dpToPx

class DotIndicatorDecoration(context: Context) : RecyclerView.ItemDecoration() {

    private val selectedColor: Int = androidx.core.content.ContextCompat.getColor(context, R.color.selected)
    private val unselectedColor: Int = androidx.core.content.ContextCompat.getColor(context, R.color.unselected)
    ...
    override fun onDrawOver(
        ...
        parent.adapter?.takeIf { it.itemCount > 0 }?.run {
            val itemCount = (this as RecyclerPagerSnapCarouselActivity.CarouselAdapter).actualItemCount
