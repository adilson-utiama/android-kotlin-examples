...
class ExpandableLayout : LinearLayoutCompat {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        if (sIsInit) {
            ...
            Log.i("TESTE", "mExpandedViewHeight Build: $mExpandedViewHeight")
            sIsInit = false
            mExpandState = CLOSED
            super.onMeasure(widthMeasureSpec, heightMeasureSpec)
        }
    ...
    fun decreaseLayoutSize(value: Int){
        verticalAnimate(mExpandedViewHeight, mExpandedViewHeight - value)
        mExpandedViewHeight -= value
    }

    fun increaseLayoutSize(adapterViewHeight: Int?) {
        if(adapterViewHeight != null){
            verticalAnimate(mExpandedViewHeight, mExpandedViewHeight + adapterViewHeight)
            mExpandedViewHeight += adapterViewHeight
        }else{
    ...
    fun toggleExpandView(){
        toggle()
    }

    fun expandExpandView(){
        expand()
    }
